...
w = ws .. "lapd"
L["wep." .. w .. ".name.full"] = "PK Series D 5223"
L["wep." .. w .. ".name"] = "That Gun"
L["wep." .. w .. ".desc"] = "Custom-made replica of an iconic film weapon, featuring excellent handling and an integrated laser sight."
L["wep." .. w .. ".desc.quote"] = "\"Quite an experience to live in fear, isn't it? That's what it is to be a slave.\""
L["wep." .. w .. ".trivia.manufacturer"] = "Pfläger-Katsumata"
...
L["wep." .. w .. ".name"] = "OA-93"
L["wep." .. w .. ".desc"] = "AR-15 derived pistol with a top charging handle, designed to circumvent legal restrictions. Jury rigged for automatic fire, so it requires time to ramp up its fire rate."
...
L["wep." .. w .. ".desc.quote"] = "Package is secure, Extraction complete."
...
L["att.barrel_coachgun_short.name.full"] = "Coachgun Shortened Barrels"
...
L["att.ammo_p2a1_heal.name.full"] = "P2A1 Medi-Smoke Cartridges"
L["att.ammo_p2a1_heal.name"] = "Medi-Smoke"
L["att.ammo_p2a1_heal.desc"] = "Flares that produce a tiny amount of restorative gas on impact."
...
L["att.ammo_p2a1_rocks.name.full"] = "P2A1 Rock Shotshells"
L["att.ammo_p2a1_rocks.name"] = "Rocks"
L["att.ammo_p2a1_rocks.desc"] = "Neolithic buckshot."
...
L["att.ammo_p2a1_signal.name.full"] = "P2A1 Signal Flare Cartridges"
L["att.ammo_p2a1_signal.name"] = "Signal"
L["att.ammo_p2a1_signal.desc"] = "A brighter, longer burning flare for distress signaling."
