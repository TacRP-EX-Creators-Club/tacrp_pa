...
SWEP.Description_Quote = "\"That chandelier was expensive, asshole!!\"" -- Reference to a scene in a 2006 show called The Unit.
...
SWEP.Attachments = {
    [1] = {
        ...
        VMScale = 0.85,
        Pos_VM = Vector(-5, -0.65, 2),
        Pos_WM = Vector(4, 0.9, -6),
        Ang_VM = Angle(90, 0, 0),
