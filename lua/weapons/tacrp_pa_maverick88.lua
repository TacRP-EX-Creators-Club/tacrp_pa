...
// names and stuff
SWEP.PrintName = "Mossberg Maverick 88"
SWEP.AbbrevName = "Maverick"
SWEP.Category = "Tactical RP"

SWEP.SubCatTier = "4Consumer"
SWEP.SubCatType = "5Shotgun"

SWEP.Description = "Cost effective shotgun in pistol grip configuration."
...
SWEP.Credits = "Model/Texture: r_populik\nSound: ?\nAnimation: Tactical Intervention"

SWEP.ViewModel = "models/weapons/tacint_extras/v_maverick88.mdl"
...
addsound("tacint_maverick88.PumpBack", path .. "pump_backward-1.wav")
addsound("tacint_maverick88.PumpForward", path .. "pump_forward-1.wav")