...
// names and stuff
SWEP.PrintName = "Coonan .357"
SWEP.AbbrevName = "Coonan"
SWEP.Category = "Tactical RP" // "Tactical RP (Extras)"

SWEP.SubCatTier = "4Consumer"
SWEP.SubCatType = "2Magnum Pistol"

SWEP.Description = "Novelty magnum pistol based on the M1911 design."

SWEP.Trivia_Caliber = ".357 Magnum"
SWEP.Trivia_Manufacturer = "Coonan Arms"
SWEP.Trivia_Year = "1983"

SWEP.Faction = TacRP.FACTION_NEUTRAL
SWEP.Credits = [[
Model, Texture: eNse7en
Animation: Tactical Intervention
]]

SWEP.ViewModel = "models/weapons/tacint_extras/v_coonan357.mdl"
